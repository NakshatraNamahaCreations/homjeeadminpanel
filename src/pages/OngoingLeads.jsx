...
//         const sortedLeads = mappedLeads.sort(
//           (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
//         );
...
//         if (!response.ok)
//           throw new Error(
//             `Measurement API error: ${response.status} ${response.statusText}`
//           );
...
//             const ceilingsTotal = (roomData.ceilings || []).reduce(
//               (sum, c) => sum + (c.area || 0),
//               0
//             );
//             const wallsTotal = (roomData.walls || []).reduce(
//               (sum, w) => sum + (w.area || 0),
//               0
//             );
//             const itemsTotal = (roomData.measurements || []).reduce(
//               (sum, m) => sum + (m.area || 0),
//               0
//             );
//             const totalArea = (ceilingsTotal + wallsTotal + itemsTotal).toFixed(
//               2
//             );
...
//             if (
//               interiorKeys.includes(roomName) ||
//               roomName.toLowerCase().includes("bedroom") ||
//               roomName.toLowerCase().includes("washroom")
//             ) {
//               mappedMeasurements.Interior.items.push(roomItem);
//               mappedMeasurements.Interior.size = `${(
//                 parseFloat(mappedMeasurements.Interior.size) +
...
//                 parseFloat(mappedMeasurements.Exterior.size) +
//                 parseFloat(totalArea)
//               ).toFixed(2)} sq ft`;
//             } else {
//               mappedMeasurements.Others.items.push(roomItem);
//               mappedMeasurements.Others.size = `${(
//                 parseFloat(mappedMeasurements.Others.size) +
//                 parseFloat(totalArea)
//               ).toFixed(2)} sq ft`;
//             }
//           }
...
//       } catch (error) {
//         console.error(
//           "Error fetching measurements for lead ID:",
//           selectedLead?.id,
//           error.message
//         );
//         setMeasurementData({});
...
//   const uniqueServices = ["All Services", "House Painting", "Deep Cleaning"];
...
//           ? new Date(bookingData.selectedSlot.slotDate).toLocaleDateString(
//               "en-GB",
//               {
//                 day: "2-digit",
//                 month: "2-digit",
...
//           bookingData.bookingDetails.bookingTime ||
//           lead.time,
//         formName: bookingData.formName || "—",
//         city: bookingData.address
//           ? `${bookingData.address.houseFlatNumber || ""}, ${
//               bookingData.address.streetArea || ""
//             }${
...
//         vendor: bookingData.assignedProfessional
//           ? bookingData.assignedProfessional.name
//           : "Unassigned",
//         type: bookingData.selectedSlot?.slotDate
//           ? new Date(bookingData.selectedSlot.slotDate).toDateString() ===
...
//         paymentId: bookingData.bookingDetails.otp
//           ? bookingData.bookingDetails.otp.toString()
//           : lead.paymentId,
//         vendorReceived: bookingData.createdDate
//           ? new Date(bookingData.createdDate)
...
//           ? new Date(bookingData.assignedProfessional.acceptedDate)
//               .toLocaleString("en-GB", {
//                 day: "2-digit",
//                 month: "2-digit",
//                 year: "numeric",
...
//     } catch (error) {
//       console.error(
//         "Error fetching booking details for lead ID:",
//         lead.id,
//         error.message
//       );
...
//         );
//         if (!res.ok)
//           throw new Error(`Vendor API error: ${res.status} ${res.statusText}`);
...
//                       {selectedLead.services?.[0]?.category ||
//                         "Unknown Service"}
//                     </p>
...
//                           const lat =
//                             selectedLead?.address?.lat ||
//                             selectedLead?.location?.lat;
//                           const lng =
//                             selectedLead?.address?.lng ||
//                             selectedLead?.location?.lng;
...
//                           } else {
//                             alert(
//                               "No valid location available for directions."
//                             );
//                           }
//                         } catch (err) {
...
//                             <p style={{ fontSize: "12px", marginBottom: "1%" }}>
//                               <span className="text-muted">
//                                 Price: ₹{service.price} x {service.quantity}
//                               </span>
//                             </p>
//                           </div>
//                         ))}
...
//                         <strong>
//                           {" "}
//                           {selectedLead.createdOnDate ||
//                             formatIST(selectedLead.createdAt).d}{" "}
//                           :
//                           {selectedLead.createdOnTime ||
//                             formatIST(selectedLead.createdAt).t}
//                         </strong>
//                       </p>
//                     </div>
//                   </div>
...
//   fontSize: "12px",
//   width: "fit-content",
//   minWidth: "120px",       // optional for consistency
